/**
 * Term Suggestion AI Service — ECD-aware, semester-aware suggestions for Create/Edit Term.
 *
 * Part of the interconnected planning system: terms anchor lessons, weekly plans,
 * grading periods, and interactive activities. Dash uses this context to suggest
 * term names, descriptions, dates, and tips so principals set up a coherent year.
 */
...
export interface TermSuggestionInput {
  ...
  /** e.g. 'preschool' | 'school' for ECD vs R–12 context */
...
export interface TermSuggestionResult {
  ...
  /** Short tip linking this term to lessons, plans, grading, activities */
  tips?: string;
}
...
export class TermSuggestionAIService {
  /**
   * Get ECD-aware, semester-aware suggestions for a term (name, description, dates, tips).
   * Designed to support the interconnected system: terms → lessons, plans, grading, activities.
   */
