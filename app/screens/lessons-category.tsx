/**
 * Lessons Category Screen (Stub)
 * 
 * Placeholder screen to prevent routing errors.
 * This will be built out later with lessons filtering by category.
 */
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.comingSoonContainer}>
          ...
          <Text style={[styles.comingSoonDescription, { color: theme.textSecondary }]}>
            Category-specific lesson browsing is currently under development. 
            For now, you can explore all lessons from the Lessons Hub.
          </Text>
          
          {categoryId && (
            <View style={styles.categoryInfo}>
              <Text style={[styles.categoryInfoLabel, { color: theme.textSecondary }]}>
