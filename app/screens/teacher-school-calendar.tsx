/**
 * Teacher School Calendar Screen
 * Displays school events, meetings, and excursions. Uses get_school_calendar_for_teacher RPC.
 */
...
import { useSchoolCalendarForTeacher } from '@/hooks/useSchoolCalendar';
...
export default function TeacherSchoolCalendarScreen() {
  const { theme } = useTheme();
  const { data, loading, error, refetch } = useSchoolCalendarForTeacher();
        ...
        {loading ? (
          ...
          <View style={styles.center}>
            ...
            <Text style={[styles.emptySubtext, { color: theme.textSecondary }]}>
              Events, meetings and excursions will appear here.
            </Text>
          </View>
        ) : (
          <FlatList
...
const createStyles = (theme: { background: string; card?: string }) =>
  StyleSheet.create({
