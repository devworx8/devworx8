-- -----------------------------------------------------------------------------
-- Fix staff seat assignment audit FK failures when caller has no users row.
-- Also keeps support for assigning seats to teacher/admin/principal_admin roles.
-- -----------------------------------------------------------------------------
...
BEGIN
  ...
  -- Auto-provision missing users row from target profile
