-- Harden AI quota tier resolution for staff accounts that do not have
-- profile.preschool_id populated but do have organization membership.
-- This prevents premium schools from incorrectly falling back to free quotas.
