-- Fix ambiguous usage_date in get_daily_media_budget and consume_daily_media_budget.
-- RETURNS TABLE (usage_date date, ...) creates a PL/pgSQL variable that conflicts with
-- daily_media_usage.usage_date. Qualify table columns with alias u.usage_date.
-- Resolves: "column reference \"usage_date\" is ambiguous" (PostgreSQL 42702).
