 ...
 * Main stats card for regional dashboard
 */
...
interface RegionalHeroCardProps {
  regionName: string;
  regionCode: string;
  regionColor: string;
  stats: RegionalStats;
...
export function RegionalHeroCard({ regionName, regionCode, regionColor, stats }: RegionalHeroCardProps) {
  return (
    <LinearGradient
